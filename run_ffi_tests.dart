...
void main() {
  ...
  final buildDir = 'xcodebuild/DebugSIMARM64';
  final executable = 'dart-sdk/bin/dart';
  final buildDirPath = '$engineDir/$buildDir';

  for (var test in tests) {
    print("Running $test");
    final testPath = "../../$test";
    final result =
        Process.runSync(executable, [testPath], workingDirectory: buildDirPath);
